...
But during our data analysis, we came to the conclusion that, data provided by 8451 is homogeneous and every table is independent. The most significant conclusion that team withdrew during the analysis was every table was linked with other table using Foreign Keys. Finally, again reading the carbo-loading paper, the team gets to know that, the dataset provided by the 8451 is subset of their relational databases, and these datasets belong to the same dataset, hence we didn't require to do schema alignment.
#### Record Linkage 
#### Data Fusion
