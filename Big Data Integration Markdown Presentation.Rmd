...
In the future scope, the team has intended to study the interaction between two pairs of products - Pasta with Pasta Sauce and Syrup with Pancake Mix.The team might plan to ascertain the recognition index for every commodity and brand combination. Then,further analyze the amount of association between pairs of brands each belonging to at least one of the commodities(E.g. Brand X of Pasta Sauce with Brand Y of Pasta).
